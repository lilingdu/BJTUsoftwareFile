<template>
  <div id = "home" >
    ...
    <search></search>
    <!--<div id="add">
      <el-button type="primary" size="medium" @click="onAdd">新增</el-button>
    </div>-->
...
<script>
  ...
  export default {
    ...
    data() {
      ...
      return {
        //tableData: localStorage.getItem("searchData"),
        tableData:this.$store.getters.getResultData,
        header:'查询结果',
        userInfo:null,
        currentPage:1,
        pageSize:10,//默认每页显示10条
        totalItem:this.$store.getters.getResultData.length,//总数据条数
